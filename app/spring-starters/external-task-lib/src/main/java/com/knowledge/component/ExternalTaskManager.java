...
public class ExternalTaskManager {
    ...
    public static class Builder {
        ...
        public com.knowledge.component.ExternalTaskManager build() {
            try {
                ...
                this.listeners.forEach( handler -> {
                    ...
                    final TopicSubscription subscription = client.subscribe(annotation.topic())
                            .handler(com.knowledge.component.ExternalTaskHandlerDecorator.from(handler, settings)).open();

                    this.subscriptions.add(subscription);
                });

                return new com.knowledge.component.ExternalTaskManager(client, settings, subscriptions);
