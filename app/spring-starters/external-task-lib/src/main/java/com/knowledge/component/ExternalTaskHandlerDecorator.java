...
public class ExternalTaskHandlerDecorator implements ExternalTaskHandler {
    ...
    public static com.knowledge.component.ExternalTaskHandlerDecorator from(final ExternalTaskHandler handler, final ExternalTaskSettings settings) {
        return new com.knowledge.component.ExternalTaskHandlerDecorator(handler, settings);
    }
